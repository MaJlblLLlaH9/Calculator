...
// lateinint - что это ? Какой есть другой способ инициализации
    ...
    fun plus() {
        findViewById<TextView>(R.id.plus).setOnClickListener {
            setConditionField(findViewById<TextView>(R.id.plus).text.toString())
        }
    }

    fun minus() {
        findViewById<TextView>(R.id.minus).setOnClickListener {
            setConditionField(findViewById<TextView>(R.id.minus).text.toString())
        }
    }

    fun multiply() {
        findViewById<TextView>(R.id.multiply).setOnClickListener {
            setConditionField(findViewById<TextView>(R.id.multiply).text.toString())
        }
    }

    fun divide() {
        findViewById<TextView>(R.id.divide).setOnClickListener {
            setConditionField(findViewById<TextView>(R.id.divide).text.toString())
        }
    }

    fun percent() {
        findViewById<TextView>(R.id.percent)
    }
    ...
    fun clear() {
        findViewById<TextView>(R.id.clear).setOnClickListener{
            ...
            if(conditionString.isNotEmpty())   {
                condition.text = conditionString.substring(0,conditionString.length -1)
                }
            }
    }
    fun reset(){
